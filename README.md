...
Here you can also find the eBDIMS2 code (originally developed in https://doi.org/10.1038/s41467-026-69809-y, https://github.com/domenicoscaramozzino/eBDIMS2) with the extension for nucleic acids and protein-nucleic acid complexes, in order to obtain transition pathways for conformational changes in large complexes, e.g.:
